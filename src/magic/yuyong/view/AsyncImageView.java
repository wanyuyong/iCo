...
import magic.yuyong.image.ImageProcessor;
import magic.yuyong.image.ImageRequest;
import magic.yuyong.image.ImageRequest.ImageRequestCallback;
...
public class AsyncImageView extends ImageView implements ImageRequestCallback {
    ...
    public static interface OnImageViewLoadListener {
         ...
         * 
         * @param imageView The AsyncImageView that is loading
         * @param percent the loading percent
         */
        void onLoading(AsyncImageView imageView, float percent);
    }
	...
	@Override
	public void onImageRequestLoading(ImageRequest request, float percent) {
		if (mOnImageViewLoadListener != null) {
            mOnImageViewLoadListener.onLoading(this, percent);
        }
	}
}
