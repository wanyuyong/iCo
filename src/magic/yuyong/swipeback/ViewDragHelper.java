...
public class ViewDragHelper {
    ...
    private static final int BASE_SETTLE_DURATION = 350; // ms
     ...
     * callback's
     * {@link com.example.swipeback.app.lib.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.example.swipeback.app.lib.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link com.example.swipeback.app.lib.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)}
     ...
     * {@link com.example.swipeback.app.lib.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     * 
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
