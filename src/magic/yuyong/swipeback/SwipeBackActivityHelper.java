...
public class SwipeBackActivityHelper {
    ...
    public void onActivityCreate() {
        mActivity.getWindow().setBackgroundDrawable(new ColorDrawable(android.R.color.transparent));
        mActivity.getWindow().getDecorView().setBackgroundDrawable(new ColorDrawable(android.R.color.transparent));
