...
import magic.yuyong.image.ImageLoader.ImageLoaderCallback;
...
public class ImageRequest {
    ...
    public static interface ImageRequestCallback {
        ...
        /**
         * Callback to be invoked when the request is processing
         * 
         * @param request ImageRequest that is processing
         * @param percent loading percent
         */
        void onImageRequestLoading(ImageRequest request, float percent);
    }
    ...
    private class InnerCallback implements ImageLoaderCallback {
		...
		@Override
		public void onImageLoading(ImageLoader loader, float percent) {
			 if (mCallback != null && !isCancelled()) {
	                mCallback.onImageRequestLoading(ImageRequest.this, percent);
	            }			
		}
    }
